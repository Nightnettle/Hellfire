...
namespace FONTS
{
	...
	void InitFonts()
	{
		...
		watermarkfont = RENDER::CreateF("Verdana", 20, 550, 0, 0, NULL);
		...
		visuals_esp_font = RENDER::CreateF("Tahoma", 11, 350, 0, 0, SDK::FONTFLAG_OUTLINE);
		...
		visuals_name_font = RENDER::CreateF("Tahoma", 12, 600, 0, 0, SDK::FONTFLAG_OUTLINE | SDK::FONTFLAG_DROPSHADOW);
...
namespace SETTINGS
{
	...
	{
		CreateDirectory("C:\\Hellfire", NULL);

		std::string file_path = "C:\\Hellfire\\" + file_name + ".cfg";
	...
	{
		std::string file_path = "C:\Hellfire\\BlankConfig.cfg";
