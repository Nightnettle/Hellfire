...
namespace MENU
{
	namespace PPGUI_PP_GUI
	{
		...
		constexpr int OBJECT_SCROLL_SPEED = 12; // how fast you scroll
		constexpr int OBJECT_PADDING = 10; // this is the padding between objects
		...
		constexpr int FRAME_PADDING = 14; // how far "deep" into the window objects are
		...
		constexpr int COMBOBOX_HEIGHT = 18;
		...
		constexpr int TAB_PADDING = 14;
		constexpr int TAB_HEIGHT = 18;

		constexpr int VERTICAL_TAB_WIDTH = 250; // width
		constexpr int VERTICAL_TAB_HEIGHT = 16; // height of a single item
		constexpr int VERTICAL_TAB_PADDING = 2; // the padding between items
